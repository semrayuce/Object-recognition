...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback, PictureCallback
{
	 ...
	 */
	private static byte[] previewBuffer;
	...
	public void capturedImage(Bitmap testImage) {

		Mat tmp = new Mat (testImage.getWidth(), testImage.getHeight(), CvType.CV_8UC1);
		Utils.bitmapToMat(testImage, tmp);
		MainActivity.addTestImage(tmp,testImage);
	}
}
