...
void JNICALL
Java_com_example_dgrproject_dgrprojectwithcamera_NativeClass_findContourAndCropping(JNIEnv *env,
                                                                                    jobject instance,
                                                                                    jlong addrSrc,
                                                                                    jlong addrDst) {
...
void JNICALL
Java_com_example_dgrproject_dgrprojectwithcamera_NativeClass_scalingWithAspectRatio(JNIEnv *env,
                                                                                    jobject instance,
                                                                                    jlong image,
                                                                                    jint targetWidth,
                                                                                    jint targetHeight) {
...
void JNICALL
Java_com_example_dgrproject_dgrprojectwithcamera_NativeClass_sobelFilter(JNIEnv *env,
                                                                         jobject instance,
                                                                         jlong addrSrc,
                                                                         jlong addrDst) {
...
void JNICALL
Java_com_example_dgrproject_dgrprojectwithcamera_NativeClass_lbpWithHistogram(JNIEnv *env,
                                                                              jobject instance,
                                                                              jlong addrSrc,
                                                                              jlong addrDst) {
    Mat &src = *(Mat *) addrSrc;
...
void JNICALL
Java_com_example_dgrproject_dgrprojectwithcamera_NativeClass_svm(JNIEnv *env, jobject instance,
                                                                 jlong addrDst,
                                                                 jlong traindataaddr,
                                                                 jlong addrTestImage) {

    Mat &dst = *(Mat *) addrDst;
    Mat &testImage = *(Mat *) addrTestImage;
    Mat &trainImages = *(Mat *) traindataaddr;
    vector<Mat> testimgs;
    vector<int> trainLabels;

    trainImages.convertTo(trainImages, CV_32FC1);
    /// do the required manipulation on the images;
    testimgs.push_back(testImage); // Test edilecek resmimizi alıyoruz


    /// Mat trainimgsMat = asRowMatrix(trainimgs, CV_32FC1);// vector<Mat>'ı Mat türünde bir objeye çevitiyoruz
    ...
    for (int z = 0; z < trainImages.rows; z++) {
        if (z % 39 == 0 && z != 0) { // her örnekten 4 resmimiz olduğu için
    ...
    Mat testResponse;
    testResponse.convertTo(testResponse, CV_32FC1);
    ...
    dst = testResponse; // eşleşme idsini döndürüyoruz
